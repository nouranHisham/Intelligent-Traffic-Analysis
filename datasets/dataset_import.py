...
def findConnections (junction_id):    
           ...
           for tllogic in tlLogicTable:
                if (tllogic.get("id")==tl):               
                    ...
                    break
                #print("number_of_traffic_lights: ", number_of_traffic_lights)
           results= list(map(lambda con: [con.get('from'), con.get('to'), con.get('tl'),con.get('dir'), con.get('state')], connectiontable_tl[tl]))
           #print("results: ", results)
           #print("connectiontable_tl[tl]: ", connectiontable_tl[tl])
           #print("hhhh: ", lambda con: [con.get('from')])
...
xml= "C:/Users/ford_/Downloads/TAPASCologne-0.24.0/cologne2.net.xml"
node_xml="C:/Users/ford_/Downloads/TAPASCologne-0.24.0/true.nod.xml"
output_filename= "dataset-cgn-tl2.csv"
dataset= []
